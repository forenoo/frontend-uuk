    ...
    <div className="flex flex-col lg:flex-row h-dvh">
        ...
        <div className="sticky top-0 p-4 border-b border-gray-200 bg-white z-10">
          ...
          <div className="relative">
            <input
              ...
              className="w-full py-2 pl-10 pr-4 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            />
      ...
      {showMobileCart && (
        <div className="lg:hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex">
          <div className="bg-white w-full sm:w-96 h-full ml-auto flex flex-col">
